...
| :--- | :---: | :---: | :---: | :---: |
| `vyos-border01` | 1 | 1.0 GB | `2804:14d:3280:46c4::10` | `fd00:172:16:200::10` |
| `k8s-master01` | 2 | 2.5 GB | `2804:14d:3280:46c4::11` | `fd00:172:16:200::11` |
| `k8s-worker01` | 2 | 3.0 GB | `2804:14d:3280:46c4::21` | `fd00:172:16:200::21` |
| `k8s-worker02` | 2 | 3.0 GB | `2804:14d:3280:46c4::22` | `fd00:172:16:200::22` |

> **Nota de Rede:** O IP `2804:14d:3280:46c4::9` será reservado para o **Cilium LoadBalancer**, atuando como VIP único para serviços externos via BGP.
